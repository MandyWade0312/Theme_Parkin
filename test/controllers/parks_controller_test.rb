...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { history: @park.history, name: @park.name, year_built: @park.year_built } }
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { history: @park.history, name: @park.name, year_built: @park.year_built } }
